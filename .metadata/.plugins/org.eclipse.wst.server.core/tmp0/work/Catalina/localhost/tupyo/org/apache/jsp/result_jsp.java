 ...
 * Generated at: 2019-07-15 06:44:07 UTC
...
public final class result_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 request.setCharacterEncoding("UTF-8"); 
	...
	"JOIN (SELECT id, NAME FROM hubo_table) AS b ON a.id = b.id order by id;");
      ...
      out.write("        data.addColumn('string', '후보번호,후보명');\r\n");
      out.write("        data.addColumn('number', '득표수');\r\n");
      out.write("\t\t\r\n");
	...
	while (rset.next()){		
      ...
      out.write("\r\n");
      out.write("\t\t['");
      out.print(rset.getInt(1)+"번 "+rset.getString(2));
      out.write('\'');
      out.write(',');
      ...
      out.write("        var options = {'title':'개표결과',\r\n");
      out.write("                       'width':600,\r\n");
      ...
      out.write("\t\tgoogle.visualization.events.addListener(chart, 'click', (e) => {\r\n");
      out.write("\t\t\tconsole.log('click', e.targetID);\r\n");
      out.write("\t\t\tconsole.log('click', e.targetID.includes('vAxis'));\r\n");
      out.write("\t\t\tif (e.targetID.includes('vAxis')) {\r\n");
      out.write("\t\t\t\tconst label = e.targetID;\r\n");
      out.write("\t\t\t\tconst label_id = label.split('#')[3];\r\n");
      out.write("\t\t\t\tconst id = Number(label_id) + 1;\r\n");
      out.write("\t\t\t\twindow.location = \"./oneresult.jsp?id=\" + id + \"&name=\" + data.wg[label_id].c[0].v.split(' ')[1];\r\n");
      out.write("\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t});\r\n");
