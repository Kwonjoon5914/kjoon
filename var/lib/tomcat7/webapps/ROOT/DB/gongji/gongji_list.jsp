...
<title>리조트 소식</title>
<link rel="stylesheet" href="../resort/css/bootstrap.css">
<h1 align=center><B>리조트 소식</B></h1>
<%
int cnt = 0;
int startpoint = 1;
int from=0;
...
<%
	...
	ResultSet rset = stmt.executeQuery("select id, title, viewcnt, recnt, date, rootid, relevel, file from gongji order by rootid DESC, recnt asc;");
%>
...
<%
			...
			if(rset.getString(8).replace("/var/lib/tomcat7/webapps/ROOT/DB/gongji/file/","").equals("null")||rset.getString(8).replace("/var/lib/tomcat7/webapps/ROOT/DB/gongji/file/","").equals("")){
