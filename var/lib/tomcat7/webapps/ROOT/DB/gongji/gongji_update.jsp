...
<%	
	...
	ResultSet rset = stmt.executeQuery("select id, title, date, content, file from gongji where id="+key+";");
...
<table align=center>
<form name=writeform method=post action="gongji_updateok.jsp" enctype="multipart/form-data">
	<tr>
		<td>&nbsp;</td>
...
<%
	if(!rset.getString(5).replace("/var/lib/tomcat7/webapps/ROOT/DB/gongji/file/","").equals("null")){
...
%>
		<td align=center><p align=left><input type="file" name="file2" id="imgInp" required/></td>
<%
	} else {
%>
