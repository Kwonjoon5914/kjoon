...
<%	
	...
	ResultSet rset = stmt.executeQuery("select id, title, date, viewcnt, content, rootid, relevel, recnt, file from gongji where id="+key+";");
%>
...
<%
		if(rset.getString(9).replace("/var/lib/tomcat7/webapps/ROOT/DB/gongji/file/","").equals("null")||rset.getString(9).replace("/var/lib/tomcat7/webapps/ROOT/DB/gongji/file/","").equals("")){
		} else {
			out.println("<tr>");
