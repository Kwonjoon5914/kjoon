...
function add(){
	...
	<%
		...
		stmt.execute("delete from review where rootid = " + onegeul + ";");
		}else{
		stmt.execute("delete from review where recnt = " + datgeulorder + ";");
		stmt.execute("update review set recnt=recnt-1 where recnt > " + datgeulorder + ";");
		}
		stmt.close();
		conn.close();
	%>
