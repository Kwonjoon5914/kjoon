...
<form name=writeform method=post action="review_write.jsp" enctype="multipart/form-data">
...
<table align=center>
	...
	<tr>
		...
		<td><input type="text" maxlength="30" class="onlyHangul" name="title" size="50" maxlength="70" placeholder="최대 30자까지 입력가능합니다"></td>
		<td>&nbsp;</td>
	</tr>
	<tr height="1" bgcolor="#dddddd"><td colspan="4"></td></tr>
	<tr>
