	...
	public int Getticketprice(int inputType, String ageName, int treatNum) {
		...
		case 1: // 주간권
			...
			case 2: // 주간권 - 장애인 우대
				...
				break;
			case 3: // 주간권 - 국가유공자 우대
				treat_name1 = "국가유공자 우대 적용"; // 국가유공자 최대 2인까지 50프로 할인
				switch (ageName) {
				case "소인":
				case "경로":
