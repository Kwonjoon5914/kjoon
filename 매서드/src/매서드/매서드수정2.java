...
public class 매서드수정2 {
	public static int inputType = 0, inputID = 0, inputCount = 0, inputAdvantage = 0; // 키보드로 부터 입력받는 값 선언
	public static int outputPrice = 0; // 최종 출력 금액 선언
	public static int age, ageType = 0;
	...
	// 입력매서드
	public static void inputTypeCommand() {
		while (true) {
			// 권종 입력
			do {
				try {
	...
	public static void inputIDCommand() {
		String inputID_str;
		// 주민번호 입력
	...
	public static void inputCountCommand() {
		// 갯수 입력
		do {
			try {
	...
	public static void inputAdvantageCommand() {
		do {
			try {
	...
	public static void calcAgeType() {
